...
public class PhoneCam extends LinearOpMode
{
    ...
    public void runOpMode()
    {
        ...
        tele.addLine("Waiting for start");
        tele.update();
        ...
        while (opModeIsActive())
        {
             ...
             */
            tele.addData("Frame Count", phoneCam.getFrameCount());
            tele.addData("FPS", String.format("%.2f", phoneCam.getFps()));
            tele.addData("Total frame time ms", phoneCam.getTotalFrameTimeMs());
