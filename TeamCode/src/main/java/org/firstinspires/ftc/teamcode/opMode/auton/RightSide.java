...
public class RightSide extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        drive.setPoseEstimate(AutoConstants.BR_START);

        TrajectorySequence path = drive.trajectorySequenceBuilder(AutoConstants.BR_START)
                .addTemporalMarker(0, () -> {
        ...
        TrajectorySequence rightPark = drive.trajectorySequenceBuilder(path.end())
                .lineToLinearHeading(AutoConstants.BR_PARK_RIGHT)
                .back(12)
                .build();
